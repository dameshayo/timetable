...
router.get("/tests_programmes/:year/:semester", (req, res) => {
  ...
  try {
    axios
      .get(
        `https://ratiba.udom.ac.tz/index.php/downloads/data?_csrf-backend=Dk4DJuyNuB9TeHgGPNFHImoZbHwZy7ZR3DGyU3HXRRNjfkRwqriJRzUVL2oEiXZoWmALCkmY0zOISf4dHYECdA%3D%3D&year=10&semester=3358&type=2&option=programme&data%5B%5D=`
      )
      .then((programmes) => {
        const $ = cheerio.load(programmes.data);
        const colleges = [];
...
router.get("/tests_table/:type/:programme/:semester/:year", (req, res) => {
  ...
  try {
    axios
      .get(
        `https://ratiba.udom.ac.tz/index.php/downloads/view?_csrf-backend=Dk4DJuyNuB9TeHgGPNFHImoZbHwZy7ZR3DGyU3HXRRNjfkRwqriJRzUVL2oEiXZoWmALCkmY0zOISf4dHYECdA%3D%3D&year=10&semester=3358&type=${type}&option=programme&data=${programe}`
      )
      .then((timetable) => {
        res.json({
          msg: "success",
...
router.get("/ue_programmes/:year/:semester", (req, res) => {
  ...
  try {
    axios
      .get(
        `https://ratiba.udom.ac.tz/index.php/downloads/data?_csrf-backend=JBC9AEzhvCdDKtD5ozPUMj42x3o5tjX296M-z4YvUTZJIPpWCtSNfyVHh5Wba-V4Dk-gDGnlUJSj23KB6nkWUQ%3D%3D&year=10&semester=3358&type=3&option=programme&data%5B%5D=`
      )
      .then((programmes) => {
        const $ = cheerio.load(programmes.data);
        const colleges = [];
...
router.get("/ue_html_table/:type/:programme/:semester/:year", (req, res) => {
  ...
  try {
    axios
      .get(`
      https://ratiba.udom.ac.tz/index.php/downloads/view?_csrf-backend=BNCNaLKewCqRrdtaeeaghNB4T1Qo55Pu-FYWiBrGzhFp4Mo-9KvxcvfAjDZBvpHO4AEoIni09oysLlrGdpCJdg%3D%3D&year=10&semester=3358&type=${type}&option=programme&data=${programe}`
      )
      .then((timetable) => {
        // console.log(timetable);
        res.json({
