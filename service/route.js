...
router.get("/instructor_table/:type/:instructor_value/:semester/:year",(req,res)=>{
    ...
    let year=req.params.year;
        const json=[];
         try {
            axios.get(`https://ratiba.udom.ac.tz/index.php/downloads/view?_csrf-backend=hl8Pl4F69E_xOGH40cWN-5Wq65H_us1VZHbPQf778zHHbn_u4wiXGsZoJoCci9iyzP6D0pzLkhYCW6MUp56geA%3D%3D&year=${year}&semester=${semester}&type=${type}&option=instructor&data%5B%5D=${instructorValue}`).then((timetable)=>{
                // console.log(timetable);
